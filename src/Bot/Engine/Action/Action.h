...
public:
    ...
    NextAction& operator=(NextAction const& o) { relevance = o.relevance; name = o.name; return *this; }
    NextAction(NextAction&& o) noexcept : relevance(o.relevance), name(std::move(o.name)) {}
    NextAction& operator=(NextAction&& o) noexcept { relevance = o.relevance; name = std::move(o.name); return *this; }
